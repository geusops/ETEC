...
<div>
    <div class="w3-padding w3-text-grey w3-half w3-display-middle w3-center">
        <h1 class="w3-center w3-brown w3-round-large w3-margin">Minha livraria</h1>
        <div class="w3-row">
            <div class="w3-col w3-button w3-brown w3-cell w3-round-large" style="width:45%;">
                <a href="cadastro.php" style="text-decoration: none;">
                    <i class=" fa fa-plus" style="font-size: 10.5em"></i>
                    <p style="font-size: 2em">Adicionar livro </p>
                </a>
            </div>
            <div class="w3-col w3-button w3-brown w3-cell w3-round-large w3-right" style="width:45%;">
                <a href="listar.php" style="text-decoration: none;">
                    <i class="fa fa-book" style="font-size: 10.5em"></i>
                    <p style="font-size: 2em">Listar livros </p>
                </a>
                <div>
                </div>
            </div>
